...
public class UploadUtils {  
    ...
    public String[] uploadFile(HttpServletRequest request) {  
        ...
        // 普通域
        foList = (List<FileItem>) fieldsMap.get(UploadUtils.FORM_FIELDS);
        if (fiList != null) {  
	...
	public List<FileItem> getFoList() {
		return foList;
	}

	public void setFoList(List<FileItem> foList) {
		this.foList = foList;
	}  
